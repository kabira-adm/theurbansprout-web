  ...
  return (
    ...
    >
      ...
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>
          <strong>Water:</strong> this is the biggest shift of the year. Move to daily watering, often
      ...
      <p>
        This is the season most balcony problems are actually caused by overcorrection. Gardeners keep
        watering out of habit right as the rain is doing the job for them, and that&apos;s how root rot
        starts.
      </p>
      <ul className="list-disc space-y-2 pl-5">
        <li>
          <strong>Plant:</strong> leafy greens and herbs that enjoy the humidity, such as coriander, mint,
        ...
        <li>
          ...
          watering on a fixed schedule, since this is the season a schedule actively hurts you.
        </li>
        <li>
      ...
      <p>
        ...
        including repotting, major pruning, and starting new plants, that summer and monsoon aren&apos;t suited
        to.
      </p>
      <ul className="list-disc space-y-2 pl-5">
        <li>
          <strong>Plant:</strong> the widest planting window of the year covers most vegetables
          (tomatoes, chillies started early winter) and flowering annuals, and this is also the best
      ...
      <ul className="list-disc space-y-2 pl-5">
        <li>
          <strong>Soil staying wet for days after summer watering habits.</strong> This is a sign the
        ...
        <li>
          ...
          This often means cooler nights have arrived earlier than expected, and it&apos;s time to ease off
          watering frequency before winter fully sets in.
        </li>
        <li>
          <strong>Leaves scorching at the edges despite regular watering.</strong> This usually means
