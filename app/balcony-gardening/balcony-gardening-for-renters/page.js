  ...
  return (
    <ArticleLayout
      ...
      jsonLd={{
        ...
        "@type": "Article",
        headline: "Balcony Gardening for Renters",
        description:
          "Deposit-safe, fully portable balcony setups for renters — freestanding furniture instead of wall mounts, what landlords actually object to, and plants that survive a move.",
    ...
    >
      <p>
        ...
        mind right before you move out.
      </p>

      <h2 className="text-xl font-semibold text-brand-green-dark">Build on furniture, not the structure</h2>
      <p>
        The core idea for a rental-friendly setup is simple: everything that holds a plant should
        be something you own and can pick up and carry out, not something fixed to the building
        itself. That reframes the whole balcony as a furniture problem rather than an installation
        problem.
      </p>
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>
          <strong>Freestanding trellises and obelisks</strong> give climbing plants something to
          grow up without needing a wall-mounted frame, and lift straight out of their pot when it&apos;s
          time to go.
        </li>
        <li>
      ...
      <ul className="list-disc space-y-2 pl-5">
        <li>
          <strong>Holes in walls or railings.</strong> This is the big one, and the reason this
          whole approach leans on freestanding furniture. Even small anchor holes for a light wall
          planter are the most common source of deposit deductions tied to balcony gardening.
        </li>
        <li>
        ...
        <li>
          <strong>Weight on the balcony structure.</strong> A cluster of large, waterlogged pots is
          heavier than it looks, and some older buildings have real balcony load limits worth
          asking about, particularly for anything beyond a handful of small to medium pots.
        </li>
        <li>
          <strong>Visible mess from the street or to neighbours.</strong> Overflowing saucers,
          dead leaf litter, or anything hanging precariously over a railing is a common complaint
          in complexes with a shared external appearance, even when nothing is technically damaged.
        </li>
      </ul>
      <p>
      ...
      <h2 className="text-xl font-semibold text-brand-green-dark">Plants that actually survive a move</h2>
      <p>
      ...
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>
          <strong>Snake plant and ZZ plant</strong> store enough water in their leaves and rhizomes
          to handle a move without watering for several days, and don&apos;t sulk over a temporary
          change in light the way more sensitive plants do.
        </li>
        <li>
          <strong>Curry leaf and aloe vera</strong> transplant reasonably well as long as the move
          doesn&apos;t coincide with the harshest part of summer, when any root disturbance is riskier
      ...
      <p>
        For the move itself, water thoroughly a day before, avoid repotting right before or right
        after (the combined stress of a move and a root disturbance is harder on a plant than
        either alone), and give everything a shadier, more sheltered spot for the first week or two
      ...
      <p>
        ...
        minutes, and it&apos;s the kind of thing that&apos;s only useful if you did it before you needed it.
      </p>
      <p>
        A few other habits help avoid disputes entirely rather than just documenting them: sweep up
        fallen leaves and soil regularly rather than letting them build up and stain the floor over
        months, keep pots slightly clear of walls so moisture doesn&apos;t sit against them, and address
        any staining under a saucer as soon as you notice it rather than assuming it&apos;ll come off
        easily after it&apos;s set in for a year.
      </p>

      <h2 className="text-xl font-semibold text-brand-green-dark">A realistic starter list for a rental balcony</h2>
      <p>
        For a first rental setup, a genuinely portable list looks something like: one sturdy
      ...
      <h2 className="text-xl font-semibold text-brand-green-dark">Building a setup you actually want to pack up and take</h2>
      <p>
        The furniture-based approach has a genuine upside beyond avoiding deposit issues: it makes
