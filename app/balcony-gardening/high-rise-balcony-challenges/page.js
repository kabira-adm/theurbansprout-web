  ...
  return (
    ...
    >
      ...
      <p>
        ...
        direct sun stress — scorched leaf edges, wilting that doesn&apos;t recover in the evening, faster
      ...
      <p>
        Air humidity generally decreases with height above ground level — a well-documented effect
      ...
      <p>
        ...
        — a lot of common foliage plants, ferns especially, and anything that thrives in a bathroom
      ...
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>
          ...
          for anything showing crisping leaf edges — a more frequent habit than would typically be
      ...
      <p>
        ...
        pots tipping, plants snapping, anchoring and railing safety — is a structural and safety
      ...
      <p>
        ...
        humidity together — which is part of why high-rise gardening has a reputation for being
        ...
        is almost certainly a humidity problem — three different symptoms that get lumped together
      ...
      <p>
        Because these effects vary so much by exact location — which direction the balcony faces,
        how close and how reflective the surrounding buildings are, how many floors up you actually
