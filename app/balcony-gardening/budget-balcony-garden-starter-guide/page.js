  ...
  return (
    ...
    >
      ...
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li><strong>Saucers for each pot — ₹20–30 each — ₹100</strong>: to protect the balcony floor from drainage staining. Easy to forget, genuinely necessary.</li>
      ...
      <p>
        ...
        catches your eye at the nursery. Prices vary a fair bit by city and by season — nurseries
      ...
      <p>
        ...
        particularly for the plants themselves — you can check for pests, root health, and general
