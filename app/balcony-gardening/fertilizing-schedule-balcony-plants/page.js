...
export default function Article() {
  return (
    ...
    >
      ...
      <ul className="list-disc space-y-2 pl-5">
        <li>
          <strong>A white or crusty salt buildup on the soil surface</strong> — the clearest visual
        ...
        <li>
          ...
          as fertiliser &quot;burn&quot; — a sign the nutrient concentration in the soil is higher than the
          roots can handle.
        </li>
        <li>
          <strong>Lush, floppy leaf growth with few or no flowers</strong> on a plant that should be
          flowering — usually too much nitrogen relative to phosphorus and potassium, which pushes
      ...
      <ul className="list-disc space-y-2 pl-5">
        <li>
          ...
          and working up, while new growth still looks reasonably healthy — a classic nitrogen
          deficiency pattern.
        </li>
        <li>
      ...
      <p>
        ...
        day — early morning or evening — rather than under harsh midday sun, when a feed is more
      ...
      <ul className="list-disc space-y-2 pl-5">
        <li>
          <strong>Liquid vermicompost or compost tea</strong> — gentle enough to use on the more
      ...
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>
          ...
          2–3 months rather than needing repeated liquid applications — a reasonable option for
