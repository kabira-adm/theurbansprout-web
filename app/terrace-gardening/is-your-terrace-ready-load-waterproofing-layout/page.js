  ...
  return (
    ...
    >
      <p>
        ...
        gardening on borrowed time. Get them right and everything you build afterward, whether
        raised beds, a full container setup, or whatever you end up with, sits on solid ground, literally.
      </p>
      ...
      <p>
        If you&apos;re planning anything beyond a modest scatter of pots, such as a proper raised-bed setup, a
        row of large trees in containers, or anything that adds up to real, sustained weight, it&apos;s
      ...
      <p>
        ...
        walls rather than grouping them in the centre of any one room below, since the edges of a slab
      ...
      <p>
        ...
        plant is loudest about it. Zone the layout instead by watering frequency, with the daily-water
        vegetables in one area and the once-a-week aloe and succulents somewhere else entirely, and
